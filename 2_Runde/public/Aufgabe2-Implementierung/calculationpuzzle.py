...
argparser.add_argument("operation_count", type=int, help="count of the operations to guess in the output puzzle")
...
#output puzzle
print(end="\n\n")
print("◦".join([str(x) for x in numbers]) + "=" + str(output_puzzle[0]), end="\n\n")
print("".join([str(x) + y for x, y in zip(numbers, output_puzzle[1])]) + str(numbers[-1]) + "=" + str(output_puzzle[0]), end="\n\n")
print(end="\n\n")
